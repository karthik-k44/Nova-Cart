    ...
    <header className="sticky top-0 z-40 border-b border-gray-200 bg-white/80 backdrop-blur-md dark:border-gray-800 dark:bg-black">
      <Container className="flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          <Link
            to="/cart"
            className="relative flex h-10 w-10 items-center justify-center rounded-xl text-gray-700 transition-colors duration-200 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-800"
